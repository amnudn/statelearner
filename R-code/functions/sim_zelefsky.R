...
## Version: 
## Last-Updated: Nov 20 2023 (09:38) 
##           By: Anders Munch
##     Update #: 51
#----------------------------------------------------------------------
## 
...
simZelefsky_wrapper <- function(n,censoring = TRUE,simulation_input = zelefsky_sim_input, ...){
...
simZelefsky_indep_cens_wrapper <- function(n,simulation_input = zelefsky_sim_input, ...){
...
simZelefsky_simple_effect_wrapper <- function(n,simulation_input = zelefsky_sim_input, ...){
...
simZelefsky_noise_wrapper <- function(n,censoring = TRUE,simulation_input = zelefsky_sim_input, p = 5,...){
    raw_dat = simZelefsky(n = n, censoring = censoring, simulation_input = simulation_input, ...)
    out = raw_dat[, .(X1 = logPSA, X2 = stage, X3 = ggtot, X4 = sDose, X5 = hormones, time = dmos, status = 1*status, true_time = time.recur, cens_time = time.cens)]
