...
% ANDERS: Divide Fig 3 into two figures. keep y-axis fix for Outcome model panels but use different y-axes for  Censoring model.
\begin{figure}
  \centering %
  ...
  % ANDERS: add marginal censoring probability to panel titles
  \label{fig:zelefski}
\end{figure}
