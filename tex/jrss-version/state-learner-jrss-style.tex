...
% ANDERS: describe that you use a single evaluation time point and say how many
% censored, event happen before it.
%
% THOMAS: Done below now, OK?
%
...
25\%. Under the ``dependent censoring'', setting the marginal censoring
probability before this time horizon is 62\%; under the ``independent
