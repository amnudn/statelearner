...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{/tmp/babel-IUB42s/figure-Ylaz8E.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{/tmp/babel-IUB42s/figure-bpNXlw.pdf}
Zelefsky simulation setting using library consisting of Kaplan-Meier, Cox model, and random forests
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{/tmp/babel-IUB42s/figure-p5pluf.pdf}
Zelefsky simulation setting including LASSO into the library
\end{figure}
